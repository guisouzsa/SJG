...
@section('title', 'Novo Contrato - SJG')
@section('breadcrumb', 'Contratos / Novo')
...
<div class="bg-white rounded-xl shadow-lg border-l-4 border-[#7BAFD4]">
    ...
    <div class="px-6 py-5 border-b border-[#9EB9D4]/30">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-[#003262]">Cadastrar Novo Contrato</h2>
                <p class="text-sm mt-1 text-[#6699CC]">Preencha os dados do contrato</p>
            </div>
    ...
    <form action="{{ route('contratos.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="date" name="data_assinatura" id="data_assinatura" value="{{ old('data_assinatura') }}"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="descricao" id="descricao" rows="3"
                          ...
                          placeholder="Descrição do contrato">{{ old('descricao') }}</textarea>
                @error('descricao')
                    <div class="flex items-center mt-2 text-sm text-red-600">
                        <svg class="w-4 h-4 mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
