...
@section('title', 'Editar Cliente - SJG')
...
<div class="bg-white rounded-xl shadow-lg border-l-4 border-[#7BAFD4]">
    ...
    <div class="px-6 py-5 border-b border-[#9EB9D4]/30">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-[#003262]">Editar Cliente</h2>
                <p class="text-sm mt-1 text-[#6699CC]">Atualize os dados do cliente</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" 
                       name="nomeCompleto" 
                       id="nomeCompleto" 
                       value="{{ old('nomeCompleto', $cliente->nomeCompleto) }}"
                       class="w-full px-4 py-3 rounded-lg border-2 @error('nomeCompleto') border-red-500 bg-red-50 @else border-[#9EB9D4] @enderror focus:border-[#20729E] focus:ring-2 focus:ring-[#20729E]/20 transition-all duration-200 outline-none"
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       class="w-full px-4 py-3 rounded-lg border-2 @error('cpf_Cnpj') border-red-500 bg-red-50 @else border-[#9EB9D4] @enderror focus:border-[#20729E] focus:ring-2 focus:ring-[#20729E]/20 transition-all duration-200 outline-none"
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       class="w-full px-4 py-3 rounded-lg border-2 @error('telefone') border-red-500 bg-red-50 @else border-[#9EB9D4] @enderror focus:border-[#20729E] focus:ring-2 focus:ring-[#20729E]/20 transition-all duration-200 outline-none"
            ...
            <div class="md:col-span-2">
                ...
                <input type="email" 
                       ...
                       class="w-full px-4 py-3 rounded-lg border-2 @error('email') border-red-500 bg-red-50 @else border-[#9EB9D4] @enderror focus:border-[#20729E] focus:ring-2 focus:ring-[#20729E]/20 transition-all duration-200 outline-none"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="endereco" 
                          id="endereco" 
                          rows="3"
                          class="w-full px-4 py-3 rounded-lg border-2 @error('endereco') border-red-500 bg-red-50 @else border-[#9EB9D4] @enderror focus:border-[#20729E] focus:ring-2 focus:ring-[#20729E]/20 transition-all duration-200 outline-none resize-none"
